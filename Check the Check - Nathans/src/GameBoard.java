 ...
 * Nathan Graham
 * 
 * This class creates a chess board and handles checking
...
public class GameBoard {
	...
	//recursive helper for bLineCheck
	...
	//recursive helper for bDiagCheck
	...
	private boolean bPawnCheck() {
		if(this.blackY < this.gameBoard.length - 1) {
			if(blackX > 0 && gameBoard[blackY + 1][blackX - 1] == 'P') 
				return true;
			if(blackX < gameBoard.length - 1 && gameBoard[blackY + 1][blackX + 1] == 'P') 
				return true;
		}
		return false;
	}
	...
	//recursive helper for wLineCheck
	...
	//recursive helper for wDiagCheck
	...
	private boolean wPawnCheck() {
		if(whiteY > 0) {
			if(whiteX > 0 && gameBoard[whiteY - 1][whiteX - 1] == 'p') 
				return true;
			if(whiteX < gameBoard.length - 1 && gameBoard[whiteY - 1][whiteX + 1] == 'p') 
				return true;
		}
		return false;
	}
